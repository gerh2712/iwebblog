              ...
              <div class="col-12">
                ...
                <div class="row justify-content-center">
                  ...
                  <div class="col-12 mx-3 mt-4 p-4 special-color">
                    ...
                    <div>
                      <br>
                      <p class="display-1 text-light">Acceso anticipado.</p> <p class="text-light h4">Registrate para tener acceso antes que nadie</p>
                  ...
                  <div class="col-8 mb-3 ml-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-7">
                            <div class="row">
                                <div class="col-7">
                                    <p class="mb-0 text-muted h5 text-right">¿Ya tienes cuenta?</p>
                                </div>
                                <div class="col-5">
